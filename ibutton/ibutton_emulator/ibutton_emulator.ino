...
//auto ds1990 = DS2401( 0x01, 0x00, 0xA0, 0x90, 0x19, 0xDA, 0x00 );

//test
//auto ds1990A = DS2401( DS2401::family_code, 0xA0, 0xA1, 0xA2, 0xA3, 0xA4, 0xA5 );
//auto ds1990 = DS2401( DS2401::family_code, 0xB0, 0xB1, 0xB2, 0xB3, 0xB4, 0xB5 );

//reza
auto ds1990A = DS2401( 0x23, 0x5B, 0xCA, 0xC9, 0x01, 0x00, 0x0E );
auto ds1990 = DS2401( 0x23, 0x5B, 0xCA, 0xC9, 0x01, 0x00, 0x0E );
...
void setup()
{
    ...
    // Setup OneWire
    hub.attach(ds1990); // always online
...
void loop()
{
    ...
    if (blinking())
    {
        ...
        // Change between Sensor A and B every ... seconds
        if (flipFlop)
        {
            flipFlop = 0;
            hub.detach(ds1990A);
...
bool blinking(void)
{
    const  uint32_t interval    = 3000;          // interval at which to blink (milliseconds)
